...
namespace MallManagment.Server.Migrations
{
    ...
    [Migration("20221026205236_AddUserToken")]
            ...
            modelBuilder.Entity("MallManagment.Shared.Models.Adminstrator", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 10, 26, 20, 52, 35, 502, DateTimeKind.Utc).AddTicks(2380),
                            Email = "melakumen@gmail.com",
                            EmailConfirmed = true,
                            LastLoginTime = new DateTime(2022, 10, 26, 20, 52, 35, 502, DateTimeKind.Utc).AddTicks(2380),
                            LockCount = 0,
                            ModifyDate = new DateTime(2022, 10, 26, 20, 52, 35, 502, DateTimeKind.Utc).AddTicks(2380),
                            PasswordHash = new byte[] { 152, 94, 110, 76, 237, 54, 22, 69, 51, 205, 6, 75, 214, 115, 231, 68, 76, 225, 39, 158, 83, 159, 76, 43 },
                            PasswordSalt = new byte[] { 115, 182, 69, 154, 164, 230, 63, 78, 234, 128, 16, 225, 154, 1, 144, 109, 64, 123, 147, 147, 173, 98, 40, 171 },
            ...
            modelBuilder.Entity("MallManagment.Shared.Models.Employee", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2022, 10, 26, 20, 52, 35, 502, DateTimeKind.Utc).AddTicks(2092),
                            EmployeeNumber = 0,
                            ...
                            ModifyDate = new DateTime(2022, 10, 26, 20, 52, 35, 502, DateTimeKind.Utc).AddTicks(2092),
                            Occupation = "Head manager",
                            Salary = 0m,
                            StartDate = new DateTime(2022, 10, 26, 20, 52, 35, 502, DateTimeKind.Utc).AddTicks(2092),
                            Status = 111,
                            TinNumber = "1212"
                        });
                });

            modelBuilder.Entity("MallManagment.Shared.Models.UserToken", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
